...
import com.core.cscj.models.entities.Capacidad;
...
public class PlanillaMensualResponse implements Serializable, Comparable<PlanillaMensualResponse>  {
    ...
    public PlanillaMensualResponse(Integer id, Timestamp fecha, String etapa, Timestamp creationDate, Timestamp lastModifiedDate, List<CapacidadResponse> capacidades, Asignatura asignatura) {
        this.id = id;
        this.fecha = fecha;
        this.etapa = etapa;
